...
<body>
    ...
    <asp:ScriptManager ID="Scr" runat="server"></asp:ScriptManager>
      ...
      <ContentTemplate>--%>
      <asp:GridView ID="GridViewL" runat="server" AutoGenerateColumns="false" OnRowCommand ="GridViewL_RowCommand" AllowPaging =true PageSize=5 >
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                ...
                <asp:TemplateField>
                    <ItemTemplate>                        
                        <div id="jquery_jplayer_1_<%# Container.DataItemIndex %>" class="cp-jplayer"></div>
